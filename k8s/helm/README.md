...
$ helm install --name zookeeper-3.7.0 engapa/zookeeper
```
...
$ helm install --name zookeeper-3.7.0 --set global.namespace=zookeeper engapa/zookeeper
```
...
| `ImageTag`              | Zookeeper container image tag       | `3.7.0`                                                 |
...
```bash
$ helm install --name zookeeper-3.7.0 -f values.yaml engapa/zookeeper
```
